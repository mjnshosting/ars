...
class OneFileLoginApplication
{
     ...
     */
    private $db_sqlite_path = "../dbs/ars_users_db.sqlite3";
	...
	echo '<html>';
	echo '<head>';
	echo '<title>MJNS ARS Login</title>';
	...
	echo '<div align="center" style="padding-top:25px"><img src="images/mjns-ars-logo.png" alt="MJNS ARS"></div>';
	echo '<form method="post" action="' . $_SERVER['SCRIPT_NAME'] . '" name="loginform">';
	echo '<h1>Abuse Response System Login</h1>';
	...
	echo '<p><a href="http://w3layouts.com" target="_blank">Template by w3layouts</a></br><a href="' . $_SERVER['SCRIPT_NAME'] . '?action=register">Create Account / </a><a href="http://www.mjns.it" target="_blank">MJ Network Solutions</a></p>';
	echo '<link rel="icon" href="images/favicon.ico" type="image/x-icon">';
	echo '</div>';
	echo '</body>';
	echo '</html>';
	...
	echo '<div align="center" style="padding-top:25px"><img src="images/mjns-ars-logo.png" alt="MJNS ARS"></div>';
        ...
        echo '<h1>Abuse Response System Registration</h1>';
        echo '<div align="center" style="width: 80%; margin: 0 auto; padding: 6% 0 9% 0;">';
        ...
        echo '</div>';
        echo '<div align="center" class="copy-right">';
	echo '<p><a href="http://w3layouts.com" target="_blank">Template by w3layouts</a></br><a href="http://www.mjns.it" target="_blank">MJ Network Solutions</a></p></br>';
        echo '</div>';
        echo '</body>';
        echo '</html>';
    }
